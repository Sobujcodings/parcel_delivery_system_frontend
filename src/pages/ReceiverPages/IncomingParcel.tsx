...
import { useGetIncomingParcelsQuery } from "@/redux/features/parcels/getAllparcels.api";
import type { parcel } from "@/types";
import { Spinner } from "@/components/ui/spinner";

export const IncomingParcel = () => {
        ...
        isLoading ?
            ...
            <div className="mx-5 my-5">
                <Table className="">
                    ...
                    <TableBody>
                        {data?.data?.Incoming_Parcels?.map((parcel: parcel, index: number) => (
